...
export class IsLessThanOrEqualToValidator extends Validator {
    ...
    public name: string = "IsLessThanOrEqualToValidator";
    public message: string = `{propertyName} must be less than or equal to ${this.m_value}.`;
